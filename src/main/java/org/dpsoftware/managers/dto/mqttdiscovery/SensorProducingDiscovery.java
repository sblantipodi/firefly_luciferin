...
@Getter
public class SensorProducingDiscovery implements DiscoveryObject {
    ...
    public String getDiscoveryTopic() {
        return FireflyLuciferin.config.getMqttDiscoveryTopic() + "/sensor/" + getBaseGWDiscoveryTopic() + "/Firefly_Luciferin_Producing/config";
    }

    @Override
    public String getCreateEntityStr() {
        this.name = generateUniqueName("Firefly Luciferin Producing");
