...
public class Constants {
    ...
    public static final String DEFAULT_MQTT_HOST = "192.168.1.3";
    ...
    public static final String GSTREAMER_PIPELINE_PIPEWIREXDG_OPENGL = "pipewiresrc fd={1} path={2} ! videorate drop-only=true ! glupload ! glcolorconvert ! glcolorscale ! video/x-raw(memory:GLMemory),width=INTERNAL_SCALING_X,height=INTERNAL_SCALING_Y,framerate=FRAMERATE_PLACEHOLDER/1 ! gldownload ! videoconvert";
    ...
    public static final String GSTREAMER_PIPELINE_V4L2_OPENGL = "v4l2src device=/dev/video0 ! image/jpeg ! jpegdec ! videorate ! glupload ! glcolorconvert ! glcolorscale ! video/x-raw(memory:GLMemory),width=INTERNAL_SCALING_X,height=INTERNAL_SCALING_Y,framerate=FRAMERATE_PLACEHOLDER/1 ! gldownload ! videoconvert";
