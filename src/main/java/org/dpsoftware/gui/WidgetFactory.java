...
public class WidgetFactory {
    ...
    /**
     * CPU threshold value factory
     *
     * @return returns a factory that adds and subtracts 1
     */
    public SpinnerValueFactory<Integer> cpuValueFactory() {
        return new SpinnerValueFactory<>() {
            {
                setValue(MainSingleton.getInstance().config != null ? MainSingleton.getInstance().config.getCpuThreshold() : 1);
            }
            ...
            public void decrement(int steps) {
                if (getValue() > 0) {
                    setValue(getValue() - 1);
                    MainSingleton.getInstance().config.setCpuThreshold(getValue());
                }
            }
    ...
    /**
     * GPU threshold value factory
     *
     * @return returns a factory that adds and subtracts 1
     */
    public SpinnerValueFactory<Integer> gpuValueFactory() {
        return new SpinnerValueFactory<>() {
            {
                setValue(MainSingleton.getInstance().config != null ? MainSingleton.getInstance().config.getGpuThreshold() : 1);
            }
            ...
            public void decrement(int steps) {
                if (getValue() > 0) {
                    setValue(getValue() - 1);
                    MainSingleton.getInstance().config.setGpuThreshold(getValue());
                }
            }
